...
pro mrs_jade, data, topology, nb_sources, sources, demixingmat, domain = domain, mask = mask, nb_scales=nb_scales
...
COMMON MR1ENV
	...
	if N_PARAMS() LT 5 $
	then begin 
        print, 'CALLING SEQUENCE: mrs_jade, data, topology, nb_sources, sources, demixingmat, domain = domain, mask = mask, nb_scales=nb_scales'
        print, "   Topology= '1D' or '2D' or 'Sphere'"
        print, "   domain = 'initial' or 'wavelet'"
	...
	'initial' : begin
					...
					'1D'		: begin
									...
									jade, data_ok, nb_sources, demixingmat, sources
					...
					'Sphere'	:  begin
									...
									jade, data_ok, nb_sources, demixingmat, sources_temp
	...
	'wavelet' : begin					
					...
					'2D'		:   begin
									...
									if keyword_set(mr1ok) then begin					;if package mre is available
										...
										MRFILE = 'xxjade.mr'							;necessary if the procedure mr_Recons is to be used.
									...
									for num_source = 0, nb_sources-1 do begin
										...
										;end thresholding
										map_out = map_in
										mr_recons, map_in, map_out, Header=Head_heur
