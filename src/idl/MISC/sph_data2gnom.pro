...
;
; -----------------------------------------------------------------------------
pro sph_data2gnom, data, pol_data, pix_type, pix_param, do_conv, do_rot, coord_in, coord_out, eul_mat, $
...
if (small_file) then begin
    ...
    color = MAKE_ARRAY(/BYTE,xsize,ysize, Value = !P.BACKGROUND) ; white
