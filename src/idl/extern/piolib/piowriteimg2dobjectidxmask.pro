...
;	Wrapping PIOWriteIMG2DObjectIdxMask
...
MEM_TYP=[-1,1,2,4,4,8,8,-1,-1,16,-1,-1,-1,-1,8,-1]
 PIOWRITEIMG2DOBJECTIDXMASK=call_external(PIOLibIDLSO,'piowriteimg2dobjectidxmask_tempoidl', $
        data, $
 ...
 RETURN,PIOWRITEIMG2DOBJECTIDXMASK
END
