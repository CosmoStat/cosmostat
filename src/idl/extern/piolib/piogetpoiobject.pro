...
END
 ...
 PIOGETPOIOBJECT=call_external(PIOLibIDLSO,'piogetpoiobject_tempoidl', $
        MyObject, $
               /L64_VALUE) 
IF (PIOGETPOIOBJECT NE 0) THEN $
A=call_external(PIOLibIDLSO,'piomemcpy_nofreeidl',PIOGETPOIOBJECT,DATA, LONG64(NBDATA*PIOTYPESIZE(STRING(TYPE))))

 RETURN,PIOGETPOIOBJECT
END
