...
;	Wrapping PIOWriteTIMESTAMPObjectIdx
...
MEM_TYP=[-1,1,2,4,4,8,8,-1,-1,16,-1,-1,-1,-1,8,-1]
 PIOWRITETIMESTAMPOBJECTIDX=call_external(PIOLibIDLSO,'piowritetimestampobjectidx_tempoidl', $
        data, $
 ...
 RETURN,PIOWRITETIMESTAMPOBJECTIDX
END
