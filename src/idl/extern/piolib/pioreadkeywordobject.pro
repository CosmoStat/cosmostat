...
END
 ...
 PIOREADKEYWORDOBJECT=call_external(PIOLibIDLSO,'pioreadkeywordobject_tempoidl', $
        Value, $
        Comment_TMP, $
        InKeyword_TMP, $
        Type_TMP, $
        ...
        MyGroup, $
               /L64_VALUE) 
  Comment=STRING(Comment_TMP)

 RETURN,PIOREADKEYWORDOBJECT
END
