...
;	Wrapping PIOWriteTIMESTAMPObjectIdxMask
...
MEM_TYP=[-1,1,2,4,4,8,8,-1,-1,16,-1,-1,-1,-1,8,-1]
 PIOWRITETIMESTAMPOBJECTIDXMASK=call_external(PIOLibIDLSO,'piowritetimestampobjectidxmask_tempoidl', $
        data, $
 ...
 RETURN,PIOWRITETIMESTAMPOBJECTIDXMASK
END
