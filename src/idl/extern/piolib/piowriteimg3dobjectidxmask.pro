...
;	Wrapping PIOWriteIMG3DObjectIdxMask
...
MEM_TYP=[-1,1,2,4,4,8,8,-1,-1,16,-1,-1,-1,-1,8,-1]
 PIOWRITEIMG3DOBJECTIDXMASK=call_external(PIOLibIDLSO,'piowriteimg3dobjectidxmask_tempoidl', $
        data, $
 ...
 RETURN,PIOWRITEIMG3DOBJECTIDXMASK
END
