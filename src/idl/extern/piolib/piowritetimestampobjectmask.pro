...
;	Wrapping PIOWriteTIMESTAMPObjectMask
...
MEM_TYP=[-1,1,2,4,4,8,8,-1,-1,16,-1,-1,-1,-1,8,-1]
 PIOWRITETIMESTAMPOBJECTMASK=call_external(PIOLibIDLSO,'piowritetimestampobjectmask_tempoidl', $
        data, $
 ...
 RETURN,PIOWRITETIMESTAMPOBJECTMASK
END
