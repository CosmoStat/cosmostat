...
;	Wrapping PIOGetTIMESTAMPObject
...
END
 ...
 PIOGETTIMESTAMPOBJECT=call_external(PIOLibIDLSO,'piogettimestampobject_tempoidl', $
        MyObject, $
               /L64_VALUE) 
IF (PIOGETTIMESTAMPOBJECT NE 0) THEN $
A=call_external(PIOLibIDLSO,'piomemcpy_nofreeidl',PIOGETTIMESTAMPOBJECT,DATA, LONG64(NBDATA*PIOTYPESIZE(STRING(TYPE))))

 RETURN,PIOGETTIMESTAMPOBJECT
END
