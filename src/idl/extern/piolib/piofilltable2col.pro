...
END
 ...
 PIOFILLTABLE2COL=call_external(PIOLibIDLSO,'piofilltable2col_tempoidl', $
        X_Value, $
        ERR_X_Value, $
        Y_Value, $
        ERR_Y_Value, $
