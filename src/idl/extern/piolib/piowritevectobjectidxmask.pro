...
;	Wrapping PIOWriteVECTObjectIdxMask
...
MEM_TYP=[-1,1,2,4,4,8,8,-1,-1,16,-1,-1,-1,-1,8,-1]
 PIOWRITEVECTOBJECTIDXMASK=call_external(PIOLibIDLSO,'piowritevectobjectidxmask_tempoidl', $
        data, $
 ...
 RETURN,PIOWRITEVECTOBJECTIDXMASK
END
