...
END
 ...
 PIOGETVECTOBJECT=call_external(PIOLibIDLSO,'piogetvectobject_tempoidl', $
        MyObject, $
               /L64_VALUE) 
IF (PIOGETVECTOBJECT NE 0) THEN $
A=call_external(PIOLibIDLSO,'piomemcpy_nofreeidl',PIOGETVECTOBJECT,DATA, LONG64(NBDATA*PIOTYPESIZE(STRING(TYPE))))

 RETURN,PIOGETVECTOBJECT
END
