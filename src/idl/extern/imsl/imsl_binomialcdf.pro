; $Id: //depot/idl/IDL_70/idl_src/libs/imsl/imsl_6.0/lib/imsl_binomialcdf.pro#1 $
;
...
FUNCTION imsl_binomialcdf, k, $          ;INPUT Scalar: LONG
              n, $                    ;INPUT Scalar: LONG
              p, $                    ;INPUT Scalar: LONG
...
@imsl_init.pro
   ...
   ;
   err_status = 0L
   MATHSTAT_111, type, err_status, k_cvt, n_cvt, p_cvt,  $
            result
   ;
   ; Return.
   ;
