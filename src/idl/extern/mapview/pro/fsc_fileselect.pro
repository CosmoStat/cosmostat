...
Forward_Function FSC_FileSelect_Error_Message

; This method handles any typing in the directory name text widget.

Catch, theError
IF theError NE 0 THEN BEGIN
   ok = FSC_FileSelect_Error_Message(/Traceback)
   RETURN
ENDIF
...
FUNCTION FSC_FileSelect_Error_Message, theMessage, Traceback=traceback, $
...
IF event_pro NE "" OR event_func NE "" THEN BEGIN
    ...
    pseudoevent = {CW_FileSelect, self->GetTLB(), event.top, 0L, self->GetFilename(),  filename, directory}
