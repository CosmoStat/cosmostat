...
chk_and_upd, header, 'XTENSION', 'TABLE', 'ASCII table extension written by MWRFITS v0.95'
...
fxaddpar, header, 'SIMPLE', 'T','Dummy Created by MWRFITS v0.95'
...
chk_and_upd, header, 'XTENSION', 'BINTABLE', 'Binary table written by MWRFITS v0.95'
...
if bof then begin
    chk_and_upd, hdr, 'SIMPLE', 'T','Primary Header created by MWRFITS v0.95'
    chk_and_upd, hdr, 'EXTEND', 'T', 'Extensions may be present'
endif else begin
    chk_and_upd, hdr, 'XTENSION', 'IMAGE','Image Extension created by MWRFITS v0.95'
...
if (keyword_set(Version)) then begin
    print, "MWRFITS V0.95:  2000-11-06"
endif
