...
function mk_dbaodp_2p,fid,sv,step_param
...
dydp=(baoh.y-bao_h.y)/2.0d/del

dydp_bin=(baoh.y_bin-bao_h.y_bin)/2.0d/del

dyprimedp=(baoh.yprime-bao_h.yprime)/2.0d/del

dyprimedp_bin=(baoh.yprime_bin-bao_h.yprime_bin)/2.0d/del
