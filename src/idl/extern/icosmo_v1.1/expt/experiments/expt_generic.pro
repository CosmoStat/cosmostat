...
sv1_ng=40.0d                    ;# galaxies [# gals/arcmin^2]
sv1_a_survey=20000.d            ;area [sq. deg.]
sv1_eff=1.0d                    ;masking eff.
sv1_sig_int=.35d/sqrt(2.d)      ;intrinsic+noise
sv1_dndztype='smail'            ;type of gal dist
sv1_dndzp=[2.0d,1.5d]           ;param of gal dist
sv1_dndzz=-1                     ;z info for gal dist
...
; Spectrasopic Survey:
sv2_n_zbin=10                   ;# of z bins
sv2_zerror=0.00d                ;z error 
sv2_z_med=1.0d                  ;median z
sv2_ng=4.0d                     ;# galaxies [# gals/arcmin^2]
sv2_a_survey=20000.d            ;area [sq. deg.]
...
sv2_dndzz=-1                     ;z info for gal dist
...
;expt=create_struct('surveys',names,names(0),sv1,names(1),sv2,names(2),sv3)
expt={sv1:sv1,sv2:sv2,sv3:sv3}
