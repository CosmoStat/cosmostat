function expt_panstarrs1,expt_in
...
; 
;  References: Kaiser et al. (2002)
                    
names=['wide','spectra','deep']  
  
; Wide Survey:
sv1_n_zbin=10                   ;# of z bins
sv1_zerror=0.06d                ;z error  
sv1_z_med=0.75d                 ;median z
sv1_ng=5.0d                     ;# galaxies [# gals/arcmin^2]
sv1_a_survey=30000.d            ;area [sq. deg.]
sv1_eff=1.0d                    ;masking eff.
sv1_sig_int=0.3                 ;intrinsic+noise
