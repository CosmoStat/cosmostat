function expt_des,expt_in

;Aug. 2008 Written by Anais Rassat
;Numbers provided informally by Sarah Bridle August 2008.
;Based on expt_generic Written by Adam Amara 18 August 2008
...
; 
;  References for DES Wester et al. (2005)
                    
names=['wide']  
  
; Wide Survey:
sv1_n_zbin=10                   ;# of z bins
sv1_zerror=0.003d                ;z error  
sv1_z_med=0.8d                  ;median z
sv1_ng=12.0d                    ;# galaxies [# gals/arcmin^2]
sv1_a_survey=5000.d             ;area [sq. deg.]
sv1_eff=1.0d                    ;masking eff.
sv1_sig_int=0.16                ;intrinsic+noise
...
;expt=create_struct('surveys',names,names(0),sv1)
expt={sv1:sv1}
