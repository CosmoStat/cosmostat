...
;the BOSS (or SDSS III) experiment. 
;Parameters collected from http://www.sdss3.org/collaboration/description.pdf
...
sv1_z_med=0.5d                  ;median z
;For BOSS LRG Sample 1,500,000 gals covering 10,000deg^2
sv1_ng=make_array(sv1_n_zbin, value = 0.04167d) ;# galaxies [# gals/arcmin^2]
sv1_a_survey=10000.d                            ;area [sq. deg.]
sv1_eff=1                                       ;masking eff.
sv1_sig_int=-1                                  ;intrinsic+noise
sv1_dndztype='hist'                             ;type of gal dist
sv1_dndzp=[2.0d,1.5d]                           ;param of gal dist
sv1_dndzz=[0.0d, 0.175d, 0.35d, 0.525d, 0.7d]   ;z info for gal dist
