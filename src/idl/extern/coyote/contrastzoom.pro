      ...
      CASE thisEvent OF
        ...
        'UP': BEGIN
           ...
           info.currentMode = ""
              ...
              xpt = 0 > xpt < (info.zxsize-1)
              ypt = 0 > ypt < (info.zysize-1)
           ...
           *info.subimage = (*info.subimage)(x[0]:x[1], y[0]:y[1])
           ...
           Widget_Control, event.id, /Clear_Events
              ...
              ; Set the box coordinates for subsequent image subsetting.
         ...
         'MOTION': BEGIN
             ...
             info.xd = 0 > xpt < (info.zxsize-1)
             info.yd = 0 > ypt < (info.zysize-1)
...
info = { zoomImage:zoomImage, $            ; The zoom image object.
         ...
         xs:0, $                           ; Locations in the window for zooming operations.
         ys:0, $
         xd:zxsize-1, $
         yd:zysize-1 }
