...
;
; CALLING:
;     rmask = resize_mask_vec(mask, daddpix, maskEdge=maskEdge)
;
; INPUTS:
...
if N_PARAMS() LT 2  then begin 
   print, 'CALLING SEQUENCE: res =  resize_mask_vec(mask, daddpix, maskEdge=maskEdge)'
   goto, DONE
endif
