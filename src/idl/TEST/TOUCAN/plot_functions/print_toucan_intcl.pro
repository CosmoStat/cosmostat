...
imagename = filename +  '/toucan_intcl_ns_' + extra+strcompress(nside,/remove_all) + '_'+strcompress(nscale,/remove_all) + '_' + strcompress(width,/remove_all)+'.eps'
...
imagename = filename+'/toucan_intcl_mask_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
...
;; imagename = filename+'/toucan_intcl_ns_nmse_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
;; if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
;; else  window,/free
...
imagename = filename+'/toucan_intcl_ns_nmse_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
tit = 'Normalized MSE of compressed measurements - no mask'
xtit = 'wavelet filter'
...
imagename = filename+'/toucan_intcl_ns_gain_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
...
;; imagename = filename+'/toucan_intcl_ns_gain_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
;; if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
;; else  window,/free
;; tit = 'Gain on measurements estimation - no mask'
;; xtit = 'wavelet filter'
...
;; imagename = filename+'/toucan_intcl_mask_nmse_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
;; if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
;; else  window,/free
...
imagename = filename+'/toucan_intcl_mask_nmse_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
tit = 'Normalized MSE of compressed measurements - with mask'
xtit = 'wavelet filter'
...
imagename = filename+'/toucan_intcl_mask_gain_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
...
;; imagename = filename+'/toucan_intcl_mask_gain_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
;; if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
;; else  window,/free
;; tit = 'Gain on measurements estimation - with mask'
;; xtit = 'wavelet filter'
