...
imagename = '~/images/toucan_cl_ns_nmse_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
...
imagename = '~/images/toucan_cl_ns_gain_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
...
imagename = '~/images/toucan_cl_mask_nmse_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
...
imagename = '~/images/toucan_cl_mask_gain_nobars_'+extra+strcompress(nside,/remove_all)+'_'+strcompress(nscale,/remove_all)+'_'+strcompress(width,/remove_all)+'.eps'
if (print eq 1) then ops,file=imagename, /COLOR,/landscape $
else  window,/free
