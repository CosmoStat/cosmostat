...
;
; PURPOSE: open a postscript file for plot output. (see cps.pro
; to close to .ps file and to print it)
; OPTIONAL INPUT: file: file name (default=idl.ps)
;                 form: page format:
;			0: top half
;			1: full page
...
;                 bits_per_pixel: number of bits for color table (default=4)
; OUTPUT: any subsequent plot graphic output will be stored
