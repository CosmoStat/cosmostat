...
%   (maximum sparsity).
%   You can stop the iteration after |x|_0=k   
%   or |y-D*x|/|y| < e by setting options.nbr_max_atoms=k
%   or options.tol = e.
%
%   Copyright (c) 2006 Gabriel Peyr?

options.null = 0;
if isfield(options, 'nbr_max_atoms')
    nbr_max_atoms = options.nbr_max_atoms;
else
    nbr_max_atoms = 50;
end
...
if isfield(options, 'use_slow_code')
    use_slow_code = options.use_slow_code;
else
    use_slow_code = 0;
end
