...
function test_chi2_variance_homogeneity, Signal, Alpha, Chi2Score=Chi2Score, Pval=Pval
...
N = N_ELEMENTS(Signal)
Chi2Score = total(abs(Signal - mean(Signal))^2.0)
...
; Define some constants and vectors
  n  = 256   ; taille des signaux
  MC = 1e3   ; 1000 simu de MC
  B  = 1e2   ; 100 bootstrap
  sigma = 2.^linspace(-8.0,8.0,20)  ; Sigma  dans le sensibilite entre 2^-8 jusqu' 2^8
                ;  linspace cree un table de 20 valeurs qui vont de -8 a 8 
