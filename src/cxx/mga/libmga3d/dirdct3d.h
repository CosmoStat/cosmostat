...
*******************************************************************************
**
**    DESCRIPTION  Partial Radon transform followed by 2D DCT,
**    -----------  for oriented texture
**                 
**    PARAMETRES    
**    ----------    
** 
...
// sub-methods
	...
	void get_size();
	void PRadAlloc(PartialRadon3D &PR3D);
...
// Size and other getters
	inline int z0(int block_number) {return block_number*NbPlane;}
