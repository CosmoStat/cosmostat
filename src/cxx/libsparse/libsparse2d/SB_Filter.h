...
public:
    ...
    void adjoint_recons(Ifloat *TabTrans, Ifloat &Imag, int Nbr_Plan, Bool AddLastScale, int nb_thr=0);
    inline void adjoint_recons(Ifloat *TabTrans, Ifloat &Imag, int Nbr_Plan,int nb_thr) {adjoint_recons(TabTrans,Imag,Nbr_Plan,True,nb_thr);};
    inline void adjoint_recons(Ifloat *TabTrans, Ifloat &Imag, int Nbr_Plan) {adjoint_recons(TabTrans,Imag,Nbr_Plan,True,0);};
