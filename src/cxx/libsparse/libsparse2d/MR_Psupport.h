...
extern void building_imag_imag(Ifloat &Image, Ifloat &Event_Image);
...
extern void mr_psupport(Ifloat &Event_Image, MultiResol &MR_Data,
                        Ifloat &I_Abaque, MRNoiseModel &Model, 
                        type_border Border, Bool WriteAll);
                        
extern void mr_psupport(MultiResol &MR_Data, MRNoiseModel & Model, type_border Border);
