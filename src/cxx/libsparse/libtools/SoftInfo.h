...
#define ADRESS "(Service d'Astrophysique CEA-Saclay France)"
...
#define SPARSE2D_RELEASE 6.1
#define SPARSE2D_NAME "SPARSE2D"
...
class softinfo {
    ...
    void sparse2d()
    {
        Release = SPARSE2D_RELEASE;
        strcpy(Name, SPARSE2D_NAME);
        sprintf(Banner, "%s V%2.2f %s", Name, Release, ADRESS);
    }
