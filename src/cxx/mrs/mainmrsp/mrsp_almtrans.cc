...
**    Date:  22/06/09
**    
**    File:  mrsp_almtrans.cc
**
*******************************************************************************
**
**    DESCRIPTION:  ALM transformation for polarized maps
**    -------------------
**
******************************************************************************/
...
{
    fprintf(OUTMAN, "Usage: %s options TQU/TEB PolaMap_File_input ALMPola_file_output \n\n", argv[0]);
...
{
	//Call "mrsp_almtrans file_in file_out"
	...
	if( (strcmp( flag_tqu_teb, "TQU" ) != 0) && (strcmp( flag_tqu_teb, "TEB" ) != 0) )
	{
		...
		fprintf(OUTMAN, "Usage: %s TQU PolaMap_File_input ALMPola_file_output \n\n OR \n\n %s TEB PolaMap_File_input ALMPola_file_output \n\n", argv[0], argv[0]);
