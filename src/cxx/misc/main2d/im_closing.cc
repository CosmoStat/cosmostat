...
{
    fprintf(OUTMAN, "Usage: %s options Image_in Image_out\n\n", argv[0]);
...
int main(int argc, char *argv[])
{
    ...
    if (Verbose == True )
    {
       ...
       cout << "  Nl = " << Dat.nl() << endl;
       cout << "  Nc = " << Dat.nc() << endl;    
       cout << "  Closing Number = " << Order << endl;
       if (TypeElem == 1) 
    ...
    for (i=0; i < Order; i++)
    {
       switch(TypeElem)
       {
       case 1: morpho_dilation (Dat, Erode, Elstr_Size);break;
       case 2: morpho4_dilation (Dat, Erode); break;
       case 3: morpho_cercle_dilation (Dat, Erode, Elstr_Size); break;
       default: break;
       }
