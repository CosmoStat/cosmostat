...
void BordLineCol::transform(Ifloat &Data, Ifloat &Result, int NbrScaleLine, int NbrScaleCol)
{
   Result = Data;
...
void BordLineCol::recons(Ifloat &Trans, Ifloat &Result, int NbrScaleLine, int NbrScaleCol)
{
   Result = Trans;
...
void BordLineCol::transform(Ifloat &Data, int NbrScaleLine, int NbrScaleCol)
{
   int s, Dep=0;
   int Nl = Data.nl();
   int Nc = Data.nc();
...
void BordLineCol::transform_bord_V0_V1(Ifloat &Data)
{
    int Nl = Data.nl();
...
void BordLineCol::recons_bord_V0_V1(Ifloat & Data)
{
    int i,j;
    int Nl = Data.nl();
    int Nc = Data.nc();    
...
void BordLineCol::transform_bord_V1_V0(Ifloat &Data)
{
    int Nl = Data.nl();
    int Nc = Data.nc();    // cout << "Line step " << Nl << " " << Nc << endl;
    for (int i = 0; i < Nl; i++) 
...
void BordLineCol::recons_bord_V1_V0(Ifloat & Data)
{
    int i,j;
    int Nl = Data.nl();
    int Nc = Data.nc();    
...
void BordLineCol::undec_transform(Ifloat &Data, Ifloat ** & TabTrans, int NbrScaleLine, int NbrScaleCol)
{
   int i,j,s, Step=1;
   int Nl = Data.nl();
   int Nc = Data.nc();
...
void BordLineCol::undec_recons(Ifloat *& TabTrans, Ifloat &Data, int NbrScaleLine, int NbrScaleCol)
{
   int i,s, Step=1;
//   int Nl = Data.nl();
//   int Nc = Data.nc();
...
void BordLineCol::recons(Ifloat & Data, int NbrScaleLine, int NbrScaleCol)
{
    int s,s1, Dep=0;  
    int Nl = Data.nl();
    int Nc = Data.nc(); 
...
void BordLineCol::transform_one_step_line (Ifloat & Data, int Nl, int Nc, int Dep)
{
    int Nc2 = (Nc+1)/2;
    int j,i;
...
void BordLineCol::undec_transform_one_step_line (Ifloat & Data, Ifloat & Low, Ifloat & High, int Step)
{
    int Nl=Data.nl();
    int Nc=Data.nc();
    fltarray LineG(Nc);
...
void BordLineCol::recons_one_step_line(Ifloat &Data, int Nl, int Nc, int Dep)
{
   int i,j;
...
void BordLineCol::undec_recons_one_step_line (Ifloat & Low, Ifloat & High, Ifloat & Data,  int Step)
{
    int Nl=Data.nl();
    int Nc=Data.nc();
    fltarray Rec(Nc);
...
void BordLineCol::transform_one_step_col (Ifloat & Data, int Nl, int Nc, int Dep)
{
    int Nl2 = (Nl+1)/2;
    int j,i;
...
void  BordLineCol::undec_transform_one_step_col (Ifloat & Data, Ifloat & Low, Ifloat & High,  int Step)
{
    int Nl=Data.nl();
    int Nc=Data.nc();
    fltarray Col(Nl);
...
void BordLineCol::recons_one_step_col(Ifloat &Data, int Nl, int Nc, int Dep)
{
   int i,j;
...
void BordLineCol::undec_recons_one_step_col(Ifloat & Low, Ifloat & High, Ifloat & Data,  int Step)
{
    int Nl=Data.nl();
    int Nc=Data.nc();
    fltarray  ColH(Nl);
...
/*****************************************************************************/
/*****************************************************************************/
void BordLineCol::alloc(SubBand1D &SB1D, Bool UseMirror)
{
   Ptr_SB1D = &SB1D;
   Ptr_SB1D_LINE = &SB1D;
   Ptr_SB1D_COL = &SB1D;
...
/*****************************************************************************/
/*****************************************************************************/
void BordLineCol::alloc(SubBand1D &SB1D_L, SubBand1D &SB1D_C, Bool UseMirror)
{
   Ptr_SB1D = &SB1D_L;
...
void BordLineCol::directional_transform(Ifloat &Data, Ifloat &DataTrans, float AngleRot, 
...
void BordLineCol::directional_recons(Ifloat &DataTrans, Ifloat &Data, float AngleRot, 
     int NbrScaleLine, int NbrScaleCol, Bool RadianUnitAngle)
{
    Ifloat Buff;
...
void DirectionalBordLineCol::transform_col(Ifloat & Data, int Nld, int Ncd, int NScale, int Dep)
{
    int Nl = Nld;
    int Nc = Ncd;
    int Nl2 = 2*Nl;
...
void DirectionalBordLineCol::transform(Ifloat & Data, Ifloat & Trans, int NbrScaleLine, int NbrScaleCol)
{
    int Nl = Data.nl();
    int Nc = Data.nc(); 
    int Step = 1;
    ...
    if (Ptr_SB1D == NULL)
    {
       cout << "ERROR: class DirectionalBordLineCol not correctly allocated ... " << endl;
       exit(-1);
    }
...
void DirectionalBordLineCol::recons(Ifloat & Trans, Ifloat & Data, int NbrScaleLine, int NbrScaleCol)
{
    int Nl = Data.nl();
    int Nc = Data.nc(); 
    int Step = 1;
