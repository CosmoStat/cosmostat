...
***********************************************************************/
long int StochasticLib2::Poisson (double L) {
/*
...
***********************************************************************/
long int StochasticLib2::Binomial (long int n, double p) {
/*
...
***********************************************************************/
long int StochasticLib2::Hypergeometric (long int n, long int m, long int N) {
/*
...
long int StochasticLib2::BinomialModeSearch(long int n, double p) {
/* 
...
*/   
  static long int      B_n_last = -1;
  static double        B_p_last = -1.;
  static long int      B_bound, B_mode;
  ...
  if (n != B_n_last || p != B_p_last) {
    ...
    B_bound = (long int)(rc + 11.0*(sqrt(rc) + 1.0));
...
long int StochasticLib2::BinomialPatchwork(long int n, double p) {
/*
...
*/  
  ...
  static long int     B_n_last = -1;
  static double       B_p_last = -1.;
  static long int     B_k1, B_k2, B_k4, B_k5;
  ...
  if (n != B_n_last || p != B_p_last) {               // set-up
    ...
    mode = (long int) nu;
    B_k2 = (long int) ceil(nu - 0.5 - W);
    B_k4 = (long int)     (nu - 0.5 + W);
  ...
  for (;;) {
    ...
    if ((U = Random() * B_p6) < B_p2) {        // centre left
      ...
      if ((V = U - B_p1) < 0.) return(B_k2 + (long int)(U/B_f2));
      // immediate acceptance region R1 = [k1, k2)*[0, f1),  X = k1, ... k2-1
      if ((W = V / B_dl) < B_f1) return(B_k1 + (long int)(V/B_f1));

      // computation of candidate X < k2, and its counterpart Y > k2
      // either squeeze-acceptance of X or acceptance-rejection of Y
      Dk = (long int)(B_dl * Random()) + 1;
      ...
      if ((V = U - B_p3) < 0.) return(B_k4 - (long int)((U - B_p2)/B_f4));
      // immediate acceptance region R4 = [k4+1, k5+1)*[0, f5)
      if ((W = V / B_dr) < B_f5) return(B_k5 - (long int)(V/B_f5));

      // computation of candidate X > k4, and its counterpart Y < k4
      // either squeeze-acceptance of X or acceptance-rejection of Y
      Dk = (long int)(B_dr * Random()) + 1;
...
double StochasticLib2::BinomialF(long int k, long int n, double l_pq, double c_pm) {
...
long int StochasticLib2::PoissonModeSearch(double L) {
/*
...
long int StochasticLib2::PoissonPatchwork(double L) {
/*
   This subfunction generates a random variate with the poisson 
...
double StochasticLib2::PoissonF(long int k, double l_nu, double c_pm) {
...
long int StochasticLib2::HypPatchwork (long int n, long int m, long int N) {
/* 
...
*/
  ...
  if (N != H_N_last || m != H_m_last || n != H_n_last) { 
    ...
    mode  = (long int)modef;
    H_k2 = (long int)ceil(modef - 0.5 - U);  
    if (H_k2 >= mode) H_k2 = mode - 1;
    H_k4 = (long int)(modef - 0.5 + U);
    ...
    while (1) {
      ...
      if ((U = Random() * H_p6) < H_p2) {    // centre left
        ...
        // immediate acceptance region R2 = [k2, mode) *[0, f2),  X = k2, ... mode -1
        if ((W = U - H_p1) < 0.)  return(H_k2 + (long int)(U/H_f2));
        // immediate acceptance region R1 = [k1, k2)*[0, f1),  X = k1, ... k2-1
        if ((Y = W / H_dl) < H_f1)  return(H_k1 + (long int)(W/H_f1));
        ...
        // immediate acceptance region R3 = [mode, k4+1)*[0, f4), X = mode, ... k4
        if ((W = U - H_p3) < 0.)  return(H_k4 - (long int)((U - H_p2)/H_f4));
        
        // immediate acceptance region R4 = [k4+1, k5+1)*[0, f5)
        if ((Y = W / H_dr) < H_f5)  return(H_k5 - (long int)(W/H_f5));

        // computation of candidate X > k4, and its reflected counterpart V < k4
        // either squeeze-acceptance of X or acceptance-rejection of V
        Dk = (long int)(H_dr * Random()) + 1;
