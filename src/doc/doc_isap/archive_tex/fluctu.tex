...
\centerline{
\vbox{
\psfig{figure=fig_cmbcssz.pdf,bbllx=1.2cm,bblly=2cm,bburx=20.2cm,bbury=21cm,width=10cm,height=10cm,clip=}
}}
...
\centerline{
\hbox{
\psfig{figure=CSDetectRegion.pdf,bbllx=1.5cm,bblly=8.cm,bburx=19.5cm,bbury=23cm,height=6cm,width=7.5cm,clip=}
 }}
...
It is proved in \cite{DJ04b} that the excess kurtosis is asymptotically optimal for the hypothesis testing of (\ref{EqHypo1}) - (\ref{EqHypo2}) if 
\[
E [W^8] < \infty.
\]
...
\vbox{
\hbox{
\psfig{figure=fig_sphere_gaussian.pdf,bbllx=2cm,bblly=10cm,bburx=19cm,bbury=19cm,width=8.5cm,height=4.5cm,clip=}
\psfig{figure=fig_sphere_line.pdf,bbllx=2cm,bblly=10cm,bburx=19cm,bbury=19cm,width=8.5cm,height=4.5cm,clip=}
}
\hbox{
\psfig{figure=fig_sphere_gaussian_noise_snr1.pdf,bbllx=2cm,bblly=10cm,bburx=19cm,bbury=19cm,width=8.5cm,height=4.5cm,clip=}
\psfig{figure=fig_sphere_line_noise_snr1.pdf,bbllx=2cm,bblly=10cm,bburx=19cm,bbury=19cm,width=8.5cm,height=4.5cm,clip=}
}}
}
...
\centerline{
 \hbox{
\psfig{figure=fig_sphere_wt_linedroite.pdf,bbllx=2.5cm,bblly=12.5cm,bburx=19.5cm,bbury=25.5cm,width=8.5cm,height=6.5cm,clip=}
